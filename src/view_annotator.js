    ...
    */
    ...
    AnnotatorViewer.prototype.mascaraAnnotation = function(annotation) {
      ...
      if (annotation.propietary==0) {
        ...
        //If you have installed a plug-in for categorize anotations, panel viewer can get this information with the category atribute
    ...
    AnnotatorViewer.prototype.createAnnotationPanel = function(annotation) {
      ...
      var annotation_layer =  '<div  class="annotations-list-uoc" style="background-color:#ddd;"><div id="annotations-panel"><span class="rotate" title="'+ i18n_dict.view_annotations +' '+ i18n_dict.pdf_resum +'" style="padding:5px;background-color:#ddd;position: absolute; top:10em;left: -50px; width: 155px; height: 110px;cursor:pointer">'+ i18n_dict.view_annotations +'<span class="glyphicon glyphicon-menu-hamburger" style="font-size:2em"></span>' + '<span class="label-counter" style="padding:0.2em 0.3em;float:right" id="count-anotations">0</span></span></div><div id="anotacions-uoc-panel" style="height:80%"><ul class="container-anotacions"><li class="filter-panel">'+'</li></ul></div></div>';
